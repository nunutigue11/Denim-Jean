...
*Why:* This is your retention engine. World Maison's nothing-restocks model means email is the only way someone comes back at the right moment.
...
## Tone/copy rules across the whole site
- Short sentences. No marketing fluff ("elevate your style," "discover the difference").
- Always name the material/process specifically (e.g. "reclaimed canvas fire coat," not "unique upcycled jacket").
- For World Maison: always state "1 of 1" or quantity remaining. Never hide scarcity.
- For Tigue Denim: always show price range or "quote required" upfront — never make someone fill out a form to learn if they can afford it.
